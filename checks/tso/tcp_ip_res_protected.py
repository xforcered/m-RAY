...
# https://www.stigviewer.com/stig/ibm_zos_racf/2023-12-27/finding/V-223823
# Sev = med
...
def tcp_ip_res_protected(mainframe, client):
    ...
    print("       Context: https://www.stigviewer.com/stig/ibm_zos_racf/2023-12-27/finding/V-223823")
